...
For creating things like this I use Github CoPilot within Visual Studio Code, and then Github pages to host the results. It's all things that are either free or that I get _for_ free because I work in education, so is a setup that many other people could put together easily. It doesn't require a powerful computer or a fast internet connection, so if you can run Visual Studio Code then working in this way is definitely an option.